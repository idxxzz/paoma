 ...
 */
 ...
 $curlObj=new process("http://apis.map.qq.com/ws/direction/v1/driving/");
 $ret=$curlObj->gets(array("from"=>"39.915285,116.403857","to"=>"39.915285,116.803857","output"=>"json","callback"=>"cb","key"=>"EZABZ-HOCH4-ZCVUN-XZZSZ-HKUPZ-33B3J"));
 $ret=json_decode($ret);
 $smarty=new Smarty();
 $smarty->caching=false;
 $smarty->assign("luxian",$ret);

 echo $smarty->fetch("allentest.html");
 ?>